...
[![CI Suite](https://github.com/Clamp-Station/Clamp-tg/actions/workflows/ci_suite.yml/badge.svg)](https://github.com/Clamp-Station/Clamp-tg/actions/workflows/ci_suite.yml)
...
| Code                      | [https://github.com/Clamp-Station/Clamp-tg](https://github.com/Clamp-Station/Clamp-tg)                                         |
...
| Clamp Station Discord | [https://discord.gg/kCuWJRdzb7](https://discord.gg/kCuWJRdzb7)                                                                         |
| Coderbus Discord          | [https://discord.gg/Vh8TJp9](https://discord.gg/Vh8TJp9)                                                                               |

This is Clamp Station's downstream fork of bubberstation, which is in turn a fork of TG (formerly skyrat).
...
- The Clamp. main repository is run by and contributed by volunteers and hobbiests. Please be considerate with the people who help maintain our codebase. We reserve the right to permanently remove anyone who does not show both our contributors and maintainers common decency.
- # Clamp. does not operate a strict "goodboy" points system or have defined goals, and anyone is welcome to contribute to this project. That being said, the maintainers of this project are free to curate comments as seen fit to uphold a respectful environment.
